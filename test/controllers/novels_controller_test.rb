...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post novels_url, params: { novel: { text: @novel.text, title: @novel.title, user_id: @novel.user_id } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { text: @novel.text, title: @novel.title, user_id: @novel.user_id } }
